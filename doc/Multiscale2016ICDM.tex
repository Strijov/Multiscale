...
%\subfloat[]{\includegraphics[width=0.4\textwidth]{fig/online_forecasting_paradigm.eps}
\label{fg:online_frc}} \\
\def\svgwidth{0.4\textwidth}
\centering \subfloat[]
...
\def\svgwidth{0.4\textwidth}
\centering
%\subfloat[]{\includegraphics[width=0.4\textwidth]{fig/draw_object.eps}\label{fg:draw}} \\
...
%\centering\subfloat[]{\includegraphics[width=0.4\textwidth]{fig/design_matrix_generation.eps}\label{fg:design}}
