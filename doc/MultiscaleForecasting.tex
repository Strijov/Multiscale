...
\textbf{TimeSeriesRescaling()}
 ...
 Downsample $\quad \hat{\bs}_{\text{lf}}$ to $\tilde{G}$:
 
 $\tilde{\bs} = [\hat{s}_{lf}(\tilde{t}_1), \dots, ], \; \tilde{t}_i \in \tilde{G}.$
 \bigskip
