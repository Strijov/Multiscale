...
\begin{figure}[!ht]
\centering\subfloat[]{\includegraphics[width=0.4\textwidth]{resample1.png}\label{fig_resample1}}
\centering\subfloat[]{\includegraphics[width=0.6\textwidth]{resample2.png}\label{fig_resample2}}
...
\[ \bs = \left[s(\tau_1), \dots, s(T_1\tau_1), s(T_1\tau_1 + \tau_2), \dots,  s\left(\sum_{k}T_k\tau_k\right)\right], \quad \sum_k{T_k} = T.\]
